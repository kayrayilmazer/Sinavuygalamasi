...
class QuizVC: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        let que1 = Question(imgName: "", questionText: "2 + 2 Kaçtır ?", options: ["2", "4", "8", "6"], correctAns: 1, wrongAns: -1, isAnswered: false)
        let que2 = Question(imgName: "", questionText: "4 + 2 Kaçtır ?", options: ["9", "4", "3", "6"], correctAns: 3, wrongAns: -1, isAnswered: false)
        let que3 = Question(imgName: "", questionText: "6 /2 Kaçtır?", options: ["2", "4", "3", "5"], correctAns: 2, wrongAns: -1, isAnswered: false)
        let que4 = Question(imgName: "", questionText: "2 -2 Kaçtır?", options: ["2", "4", "1", "0"], correctAns: 3, wrongAns: -1, isAnswered: false)
        let que5 = Question(imgName: "", questionText: "12 x 2 Kaçtır?", options: ["24", "40", "26", "34"], correctAns: 0, wrongAns: -1, isAnswered: false)
        let que6 = Question(imgName: "", questionText: "Bulutların Rengi Nedir?", options: ["Mor", "Sarı", "Mavi", "Beyaz"], correctAns: 2, wrongAns: -1, isAnswered: false)
    ...
    func setQuestionNumber() {
        ...
        if currentPage < questionsArray.count {
            lblQueNumber.text = "Soru: \(currentPage+1) / \(questionsArray.count)"
    ...
    @objc func btnPrevNextAction(sender: UIButton) {
        ...
        lblQueNumber.text = "Soru: \(currentQuestionNumber) / \(questionsArray.count)"
    }
    ...
    func setupViews() {
        ...
        lblQueNumber.text = "Soru: \(1) / \(questionsArray.count)"
        ...
        lblScore.text = "Puan: \(score) / \(questionsArray.count)"
    }
